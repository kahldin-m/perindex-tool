...
## About (Pear-what-now?)
Perindex-Tool is a terminal‑based character archival tool for worldbuilders and writers. It provides a simple way to create, sort and retrieve locally stored character cards in a stable, human-readable format.
...
- Day 8: Function Modularity and Cleanup
  - Refactor functions for modularity. Cleanup unused or temp. commented code.
